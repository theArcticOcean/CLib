...
vtkStandardNewMacro(multiClipPolyData);

void multiClipPolyData::AddClipFunction(vtkImplicitFunction *func)
{
    ClipFunctions.push_back( func );
}

// set to 0.0; and generate clip scalars turned off.
multiClipPolyData::multiClipPolyData(vtkImplicitFunction *cf)
{
  this->InsideOut = 0;
...
//----------------------------------------------------------------------------
multiClipPolyData::~multiClipPolyData()
{
  if ( this->Locator )
  {
...
vtkMTimeType multiClipPolyData::GetMTime()
{
...
vtkPolyData *multiClipPolyData::GetClippedOutput()
{
...
//
int multiClipPolyData::RequestData(
...
void multiClipPolyData::SetLocator(vtkIncrementalPointLocator *locator)
{
...
//----------------------------------------------------------------------------
void multiClipPolyData::CreateDefaultLocator()
{
  if ( this->Locator == nullptr )
  {
...
//----------------------------------------------------------------------------
void multiClipPolyData::PrintSelf(ostream& os, vtkIndent indent)
{

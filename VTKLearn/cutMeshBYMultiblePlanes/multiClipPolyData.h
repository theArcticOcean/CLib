...
=========================================================================*/
/**
 * @class   multiClipPolyData
 * @brief   clip polygonal data with user-specified implicit function or input scalar data
 *
 * multiClipPolyData is a filter that clips polygonal data using either
 ...
 *
 * @warning
 * In order to cut all types of cells in polygonal data, multiClipPolyData
...
#ifndef multiClipPolyData_h
#define multiClipPolyData_h
...
class multiClipPolyData : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(multiClipPolyData,vtkPolyDataAlgorithm);
...
protected:
  multiClipPolyData(vtkImplicitFunction *cf=nullptr);
  ~multiClipPolyData() override;
...
private:
  multiClipPolyData(const multiClipPolyData&) = delete;
  void operator=(const multiClipPolyData&) = delete;
};

...
int main(int, char *[])
{
  ...
  std::cout << pointNormalsRetrieved << std::endl;
  ...
  pointNormalsRetrieved->ClearLookup();  // release all internal objects.
  ...
  ///////// Get Point Normals ///////////
  pointNormalsRetrieved = vtkDoubleArray::SafeDownCast(polydata->GetPointData()->GetNormals());
  std::cout << pointNormalsRetrieved << std::endl;
  if(pointNormalsRetrieved)
  {
    std::cout << "There are " << pointNormalsRetrieved->GetNumberOfTuples()

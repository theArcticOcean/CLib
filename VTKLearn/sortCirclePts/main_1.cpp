...
//    {
        auto p1 = ptIds->GetId( 0 );
        auto p2 = ptIds->GetId( 1 );
        cout << p1 << " " << p2 << endl;
        polyData->GetCellEdgeNeighbors( 0, p1, p2, neiCellIds );
        cout << "neiCellIds count: " << neiCellIds->GetNumberOfIds() << endl;
//    }
    ...
    while ( sortedIds.size() < polyData->GetNumberOfPoints() )
    {
        ...
        while( index >= 0 && !foundCell )
        {
            ...
            {
                cout << sortedIds[index] << ", neighborCellIds->GetNumberOfIds: " << neighborCellIds->GetNumberOfIds() << endl;
            }
    ...
    cout << "size: " << sortedIds.size() << " vs "
         << selectionPoints->GetNumberOfPoints() << endl;
    ...
    //for( int i = 0; i < selectionPoints->GetNumberOfPoints(); ++i )
    {
        ...
        double scaleValue = 0.003; // * 10;
        text2DTransform->Scale( scaleValue, scaleValue, scaleValue );

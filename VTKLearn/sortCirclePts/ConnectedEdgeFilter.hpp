...
public:
    ...
    void Initialise( vSP<vtkCellArray> edgeSegments )
    {
        m_EdgeSegments = edgeSegments;
        m_EdgeSegments->InitTraversal();
        m_ConnectedLists.clear();
        vSPNew( cell, vtkIdList );
    ...
    void HandleEdges()
    {
        ...
        while ( edgeIndex !=-1 )
        {
            ...
            // connect both list
            vSPNew( connectedList, vtkIdList );
...
protected:
    vSP<vtkCellArray>               m_EdgeSegments;
